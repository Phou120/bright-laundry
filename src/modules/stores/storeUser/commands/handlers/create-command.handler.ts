...
import { CreateStoreUserCommand } from '../create.command';
...
@CommandHandler(CreateStoreUserCommand)
export class CreateHandler
  implements
    ICommandHandler<CreateStoreUserCommand, ResponseResult<StoreUserOrmEntity>>
{
  constructor(
  ...
  async execute(
    command: CreateStoreUserCommand,
